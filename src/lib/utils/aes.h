 ...
 * aes.h
 *
 *	AES-NI wrapper based Peter Rindall's cryptoTools
 *  Created on: Apr 22, 2018
 *
 */

#ifndef SRC_LIB_UTILS_AES_H_
#define SRC_LIB_UTILS_AES_H_
...
namespace lbcrypto{
    ...
    public:
        ...
        void ecbEncBlocks(const block* plaintexts, ui64 blockLength, block* cyphertext) const;
        ...
        void ecbEncCounterMode(ui64 baseIdx, ui64 length, block* cyphertext);
