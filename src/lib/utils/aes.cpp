...
void AES::ecbEncBlocks(const block * plaintexts, ui64 blockLength, block * cyphertext) const
{
    const ui64 step = 8;
    ui64 idx = 0;
    ui64 length = blockLength - blockLength % step;
...
void AES::ecbEncCounterMode(ui64 baseIdx, ui64 blockLength, block * cyphertext)
{
    const ui64 step = 8;
    ui64 idx = 0;
    ui64 length = blockLength - blockLength % step;
