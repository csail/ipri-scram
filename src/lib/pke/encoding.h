...
namespace lbcrypto {
	...
	uv64 packed_encode(const dv& input, const ui64 delta, const ui64 mod_p, const ui32 logn);

	uv64 packed_decode(const uv64& input, const ui64 mod_p, const ui32 logn);
	dv packed_decode(const uv64& input, const ui64 delta, const ui64 mod_p, const ui32 logn);
